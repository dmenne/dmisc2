...
#' @return a grob object for arranging, for direct printing or chaining with "+"
...
#'  ggkm(fit,timeby=500)
#'  ggkm(fit,table = TRUE)
#'  # Piping works when no table is added
#'  ggkm(fit) + scale_x_continuous(limits=c(0,500)) 
#'  # This does not work, because a grob is returned
